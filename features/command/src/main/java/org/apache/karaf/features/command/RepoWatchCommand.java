...
import org.apache.karaf.features.core.RepoWatcherImpl;
...
@Command(scope = "feature", name = "repo-watch", description = "Watch a features repository")
@Service
public class RepoWatchCommand extends FeaturesCommandSupport {
    ...
    protected void doExecute(FeaturesService featuresService) throws Exception {
        ...
        try {
            System.out.println("Start watching feature url: " + uriString);
            uris.forEach(uri -> repoWatcher.add(uri.toString()));
        } catch (Exception e) {
            System.err.println("Error watching " + uriString + ": " + e.getMessage());
        }
    }
